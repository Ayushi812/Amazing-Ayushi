...
class Contacts(db.Model):
    ...
    phone_num = db.Column('phone_num',db.String(12), nullable=False)
...
class Posts(db.Model):
    ...
    tagline = db.Column('tagline',db.String(120), nullable=False)
    slug = db.Column('slug',db.String(21), nullable=False)
    content = db.Column('content',db.String(120), nullable=False)
    date = db.Column('date',db.String(12), nullable=True)
    img_file = db.Column('img_file',db.String(12), nullable=True)
...
def contact():
    if(request.method=='POST'):
        ...
        db.session.commit()
        flash("Thanks for filling...We'll get back to you soon","success")
